...
There are some ways to create a new repository for this theme:

1. [**Forking on GitHub**](#option-1-forking-on-github) - Convenient for custom development, but difficult to upgrade. Unless you are familiar with Jekyll and are determined to tweak or contribute to this project, this approach is not recommended.
...
Fork **[{{ site.data['theme']['nickname'] }}][theme-fork]** on GitHub and rename it as you like. Please note that the default branch code is in development.  If you want the site to be stable, please switch to the [latest tag][latest-tag] and start writing.
...
1. Removes the files under `books/`{: .filepath}
...
If you need to customize the stylesheet, create a new file `_sass/stylesheet-custom.scss`{: .filepath} and assign new values to the target variable in it.
